...
namespace Core
{
    ...
    {
        public static Tuple<Int32, String[]> ForgeHeaderTuple(FormBinaryData data)
        {
            ...
            {
                binaryReader.BaseStream.Seek(data.HeaderAddress, SeekOrigin.Begin);
                ...
                do
                {
                    ...
                    binaryReader.BaseStream.Seek(data.HeaderAddress + (data.ChunkSize * ordinal), SeekOrigin.Begin);
