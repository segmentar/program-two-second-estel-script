...
namespace Core
{
    ...
    {
        public static Tuple<Int32, String[]> ForgeLocalLineTuple(FormBinaryData data)
        {
            ...
            {
                binaryReader.BaseStream.Seek(data.LocalLineAddress, SeekOrigin.Begin);
                ...
                do
                {
                    ...
                    binaryReader.BaseStream.Seek(data.LocalLineAddress + (data.ChunkSize * ordinal), SeekOrigin.Begin);
